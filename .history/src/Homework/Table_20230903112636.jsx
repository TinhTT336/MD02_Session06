...
export default function Table() {
    ...
    return (
        <>
            ...
            {showFormAdd ? <AddModal handleCloseFormAdd={handleCloseFormAdd} listStudent={listStudent} /> : <></>}
                ...
                <div className="table-responsive">
                    <div className="table-wrapper">
                        ...
                        <table className="table table-striped table-hover">
                            ...
                            <tbody>
                                {listStudent.length === 0 ? (<tr aria-colspan={5}>Khong co du lieu</tr>) : (<>{listStudent.map((st) => (
                                    <tr>
                                        <td>
                                            <span className="custom-checkbox">
                                                <input
