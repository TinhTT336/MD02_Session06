                            ...
                            <form>
                                ...
                                <div className="modal-body">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" name='studentName' value={studentName} onChange={handleChange} />
                                    </div>
                                    <div className="form-group">
                                        <label>Email</label>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" required="" name='phone' value={phone} onChange={handleChange} />
                                    </div>
                                </div>
